...
3.  **Vectorization:** Converting the cleaned text into numerical representation.
    * *Note: Currently using [TF-IDF / CountVectorizer / BERT] to create vectors.*
...
* **Constraint:** *[Optional: Mention your instruction type constraint here, e.g., "2 bits are currently used to determine the instruction type logic in the processing pipeline."]*